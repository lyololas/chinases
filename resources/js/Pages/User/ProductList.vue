            ...
            <div>
                            ...
                            <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                                ...
                                <DialogPanel
                                    ...
                                    <form class="mt-4 border-t border-gray-200">
                                        ...
                                        <ul role="list" class="px-2 py-3 font-medium text-gray-900">
                                            <li v-for="category in categories" :key="category.id">
                                                <div class="flex items-center">
                                                  <input :id="`mobile-filter-${category.id}`" type="checkbox"
                                                         :value="category.id" v-model="selectedCategories"
                                                         class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                                  <label :for="`mobile-filter-${category.id}`" class="ml-3 text-gray-500">
                                                    {{ category.name }}
                                                  </label>
                                                </div>
                                            </li>
                                        ...
                                        <Disclosure as="div" v-for="section in [{id: 'brand', name: 'Brands', options: brands}]" :key="section.id"
                                            ...
                                            <DisclosurePanel class="pt-6">
                                                <div class="space-y-6">
                                                    <div v-for="brand in section.options" :key="brand.id" class="flex items-center">
                                                        <input :id="`filter-mobile-brand-${brand.id}`" :value="brand.id" type="checkbox"
                ...
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Меню</h1>
